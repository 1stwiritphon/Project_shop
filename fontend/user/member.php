    ...
    <body>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" action="cart.php">
                        <a class="nav-link active mt-2 text-black" aria-current="page" href="./profile.php"> <?php echo $_SESSION['User_first']; ?></a>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
        ...
        <header class="bg-dark py-0">
            <div class="text-center text-white ">
                <a href="">
                <img src="assets/page1.jpg" style="width: 100%; margin: 0;" class="">
                </a>
            </div>
        </header>
        <!-- Section-->
                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <a href="cart.php?Menu_ID=<?php echo $row['Menu_ID'] ?>&act=add&User_ID<?php echo $_SESSION['user'] ?>" class="btn btn-outline-dark mt-auto">หยิบใส่ตะกร้า</a>
                                    </div>
                                </div>
                            </div>
                        </div>

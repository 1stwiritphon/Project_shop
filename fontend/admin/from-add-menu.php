...
-->
  ...
  <body class="hold-transition sidebar-mini">
    <form action="../../backend/process-add-menu.php " method="post" enctype="multipart/form-data" name="upfile" id="upfile">
              ...
              <div class="row">
                  ...
                  <div class="card card-primary">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" id="Menu_name" class="form-control" name="Menu_name" placeholder="ชื่อเมนู" required>
                      </div>
                      <div class="form-group">
                        <label for="inputClientCompany">ราคา</label>
                        <input type="text" id="inputClientCompany" class="form-control" name="Menu_price" placeholder="ราคา" required>
                      </div>
                      <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="card card-secondary">
                    <div class="card-header">
                      <h3 class="card-title">วัตถุดิบที่ใช้</h3>
                      <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                          <i class="fas fa-minus"></i>
                        </button>

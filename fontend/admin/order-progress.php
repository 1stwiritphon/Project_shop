...
$sql = " SELECT DISTINCT c.o_dttm, a.user_id, a.username, a.user_first, a.user_last, a.user_address, c.o_id, b.status,b.update_time
FROM order_detail b, user a, order_head c
                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_array($order)) { ?>
                          <tr>
                            ...
                            <!--<a href="custom-order.php?customer_id=<?php echo $row['customer_id']; ?>&order_id=<?php echo $row['order_id']; ?>"> -->
                            <td><a href="order-detail-process.php?user_id=<?php echo $row['user_id']; ?>&o_id=<?php echo $row['o_id']; ?>"><button type="submit" value="Edit" class="btn btn-primary" name="edit"><i class="fas fa-edit"></i></button></a>
                          </tr>

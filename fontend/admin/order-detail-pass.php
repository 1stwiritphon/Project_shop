...
$sql = "SELECT distinct  c.o_dttm,a.Menu_name,b.d_qty,b.d_subtotal , b.status from menu a, order_detail b, order_head c , user u
...
<!DOCTYPE html>
  ...
  <form action="../../backend/process-update-pass-to-success.php" method="post"  name="update" id="update">
              ...
              <div class="card-body">
                <table id="order" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        ...
                        <tr>
                          <td><?php echo $i;?></td>
                          <td><p><?php echo $row ['Menu_name']?></p></td>
                          <td><p><?php echo $row ['d_qty']?></p></td>
                          <td><p><?php echo $row ['d_subtotal']?></p></td>

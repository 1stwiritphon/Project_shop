                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_array($order)) { ?>
                          <tr>
                            ...
                            <td><a href="order-detail.php?user_id=<?php echo $row['user_id']; ?>&o_id=<?php echo $row['o_id']; ?>"><button type="submit" value="Edit" class="btn btn-primary" name="edit"><i class="fas fa-edit"></i></button></a>
                          </tr>

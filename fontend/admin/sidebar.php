        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item openM2">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="order-progress.php" class="nav-link activeM23">
                  <i class="far fa-circle nav-icon"></i>
                  <p>กำลังทำ</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="order-pass.php" class="nav-link activeM24">
                  <i class="far fa-circle nav-icon"></i>
                  <p>กำลังส่ง</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="order-success.php" class="nav-link activeM25">
                  <i class="far fa-circle nav-icon"></i>
                  <p>สำเร็จ</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="order-cancel.php" class="nav-link activeM26">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ยกเลิก</p>
                </a>
              </li>
          ...
          <li class="nav-item">
          <a href="form-add-inven.php" class="nav-link activeM44">
              <i class="far fa-circle nav-icon"></i>
              <p>เพิ่มวัตถุดิบ</p>
          </a>
    </li>
    <li class="nav-item">
    <a href="from-report.php" class="nav-link activeM45">
        <i class="far fa-circle nav-icon"></i>
        <p>รายงาน</p>
    </a>
</li>
          ...
          <li class="nav-item">
            <a href="../../backend/logout.php" class="nav-link activeM7">
